...
LogRobot::LogRobot()
  : Label("data-service"), enable_(false), path_("."),
...
//  } // end while
  ...
  cfg->get_value(sub_tag, "registry", str);
...
void LogRobot::start() {
    ThreadPool::instance()->add("data-log", &LogRobot::tick, this);
}
...
CLASS_LOADER_REGISTER_CLASS(agile_robot::LogRobot, Label)
